...
class DifferentialDriveConstants(
    ...
    val width: Length,
    val velocityPID: PIDConstants = PIDConstants(0, 0, 0),
    val velocityFF: AngularMotorFFEquation = AngularMotorFFEquation(0, 0, 0),
    ...
    companion object{
        fun andymarkKitbot(
            ...
            velocityPID: PIDConstants = PIDConstants(0,0,0),
            velocityFF: AngularMotorFFEquation = AngularMotorFFEquation(0,0,0),
            robotRotationPID: PIDConstants = PIDConstants(0.4,0,0),
